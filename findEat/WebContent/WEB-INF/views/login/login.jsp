...
<form class="form-signin" action="loginPro.do" method="post">
	...
	<div class="align-bottom mx-auto" style="height:50px;width:285px">
		<div id="naverIdLogin" class="btn my-0 py-0 px-1" style="float:left;height:40px;"></div>  <!-- 버튼이 들어갈 위치 선언. ID는 반드시 지정된 값으로 설정하여야 합니다.-->
		<div class="g-signin2 px-1"
			 data-onsuccess="onSignIn" data-theme="dark"
			 data-height="50" data-width="131.19" style="float:left;"></div> <!-- Google login -->
	</div>
	<script type="text/javascript">
