...
(function(window, Calendar) { /// 실행시간 동작 스크립트
    ...
    // event handlers
    cal.on({ // e is ... api 문서의 Schedule 항목 데이터들
        ...
        'afterRenderSchedule': function(e) { /////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            console.log('after', e.schedule.id, e.schedule.calendarId, e.schedule);
            window.location="addcal.do?id="+e.schedule.title;
        },
